	...
	<div id="bittop">
		...
		<div id="logo">
		  <a href="{$smarty.const.BIT_BASE_URI}/wiki/index.php">
		  	<img src="{$smarty.const.CONFIG_PKG_URL}themes/lsces2/images/logo2.jpg">
		  </a>
		</div>
		<div id="hc1" class="haccordion">
		  <ul>
		    <li>
		      <div class="hpanel">
		    	<a href="{$smarty.const.BIT_BASE_URI}/wiki/index.php?page=medw">
		    	  <img src="{$smarty.const.CONFIG_PKG_URL}themes/lsces2/images/medw.jpg" style="float:left; width:320px; height:200px" />
		    	</a>
		      </div>
		    </li>
		    <li>
		      <div class="hpanel">
		    	<a href="{$smarty.const.BIT_BASE_URI}/wiki/index.php?page=enquirysolve">
		    	  <img src="{$smarty.const.CONFIG_PKG_URL}themes/lsces2/images/enquirysolve.jpg" style="float:left; width:320px; height:200px" />
		    	</a>
		      </div>
		    </li>
		    <li>
		      <div class="hpanel">
		    	<a href="{$smarty.const.BIT_BASE_URI}/wiki/index.php?page=Product+Index">
		    	  <img src="{$smarty.const.CONFIG_PKG_URL}themes/lsces2/images/electronickits.jpg" style="float:left; width:320px; height:200px" />
		    	</a>
		      </div>
		    </li>
		    <li>
		      <div class="hpanel">
		    	<a href="{$smarty.const.BIT_BASE_URI}/wiki/index.php?page=Projects">
		    	  <img src="{$smarty.const.CONFIG_PKG_URL}themes/lsces2/images/projects.jpg" style="float:left; width:320px; height:200px" />
		    	</a>
		      </div>
		    </li>
		    <li>
		      <div class="hpanel">
		    	<a href="{$smarty.const.BIT_BASE_URI}/fisheye/view.php?gallery_id=15">
		    	  <img src="{$smarty.const.CONFIG_PKG_URL}themes/lsces2images/library.jpg" style="float:left; width:320px; height:200px" />
		    	</a>
		      </div>
		    </li>
		    <li>
		      <div class="hpanel">
		    	<a href="{$smarty.const.BIT_BASE_URI}/wiki/index.php?page=Contact">
		    	  <img src="{$smarty.const.CONFIG_PKG_URL}themes/lsces2/images/aboutus.jpg" style="float:left; width:320px; height:200px" />
		    	</a>
		      </div>
		    </li>
		  </ul>
